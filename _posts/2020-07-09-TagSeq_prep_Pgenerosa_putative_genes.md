...
## Objective:
  ...
  - investigate mitchondrial mechanism(s) driving the differential phenotype
    - **Acclimated** = ↑ growth, ↑ metabolic rate, ↓ CSR
        - *proposed pathway*: Alternate oxidase
    - **Not Acclimated** = ↓ growth, ↓ metabolic rate, ↑ CSR
        - *proposed pathway*: Reverese electron transport (RET) or Mitchondrial dysfunction
          - *additionally... sirtuin, UCP, and UPR response*
